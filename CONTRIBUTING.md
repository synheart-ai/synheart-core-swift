...
Thank you for taking the time to look at Synheart Core (Swift). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-core-swift/issues) to avoid
   duplicates.
...
Be respectful in issues and discussions. See [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md)
for the full policy. We reserve the right to close issues that are abusive,
off-topic, or used to spam the tracker.
