...
///
/// Mirrors the runtime's `HsvAxisValue { score, confidence }`.
/// Score is nil when the signal is unavailable; confidence reflects
...
/// a confidence score. Mirrors the runtime's `PhysiologyState`.
///
