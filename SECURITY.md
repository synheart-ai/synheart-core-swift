...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-core-swift/security/advisories/new).
...
This policy covers the `SynheartCore` SDK published from this repository. Issues
